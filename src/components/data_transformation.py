...
class DataTransformationConfig:
    ...
    #create paths to save the data oin 
...
class DataTrasformation:
    ...
    def get_data_transformer_object(self):
        ...
        """
        this function is responsible for data transformation with respect to data types
        ...
        try:
            ...
            cat_pipepline = Pipeline(
                steps = [
                    ...
                    ("OneHotEncoder",OneHotEncoder()), #this dependce on the variance of the categrorical variables 
                    ("scaler",StandardScaler(with_mean=False))
                ]
            )
